...
[[m_push_var,`push_var(...)`]]`((push_var))(Name, Value)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_null_vars,`null_vars(...)`]]`((null_vars))(...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_macro,`macro(...)`]]`((macro))(Name, Body)` +
[[m_null_macro,`null_macro(...)`]]`((null_macro))(Name, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_set_macro,`set_macro(...)`]]`((set_macro))(Name, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_push_macro,`push_macro(...)`]]`((push_macro))(Name, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_must_exist,`must_exist(...)`]]`((must_exist))(Name)` +
[[m_var_must_exist,`var_must_exist(...)`]]`((var_must_exist))(Name)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[v_status,`$status`]]`$((status))` (Universal variable)
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[v_sticky_status,`$sticky_status`]]`$((sticky_status))` (Universal variable)
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_sticky_status,`sticky_status()`]]`((sticky_status))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_reset_sticky_status,`reset_sticky_status()`]]`((reset_sticky_status))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_if,`if(...)`]]`((if))(Cond, TrueBody, ...)` +
[[m_unless,`unless(...)`]]`((unless))(Cond, TrueBody, FalseBody)` +
[[m_else_if,`else_if(...)`]]`((else_if))(Cond, TrueBody, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_if_eq,`if_eq(...)`]]`((if_eq))(String1, String2, TrueBody, ...)` +
[[m_if_neq,`if_neq(...)`]]`((if_neq))(String1, String2, TrueBody, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_if_null,`if_null(...)`]]`((if_null))(Var, Body, ElseBody)` +
[[m_if_var_def,`if_var_def(...)`]]`((if_var_def))(Var, Body, ElseBody)` +
[[m_if_var_ndef,`if_var_ndef(...)`]]`((if_var_ndef))(Var, Body, ElseBody)` +
[[m_if_defined_as,`if_defined_as(...)`]]`((if_defined_as))(Var, Value, Body, ElseBody)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_else,`else(...)`]]`((else))(Body)` +
[[m_if_so,`if_so(...)`]]`((if_so))(Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_else_if_def,`else_if_def(...)`]]`((else_if_def))(Name, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_case,`case(...)`]]`((case))(Name, Value, TrueBody, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_loop,`loop(...)`]]`((loop))(InitList, DoBody, WhileCond, WhileBody)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_repeat,`repeat(...)`]]`((repeat))(Cnt, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_recurse,`recurse(...)`]]`((recurse))(max_depth, macro, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_open_quote,`open_quote()`]]`((open_quote))()` +
[[m_close_quote,`close_quote()`]]`((close_quote))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[v_arg_comma,`$arg_comma`]]`$((arg_comma))` (Universal variable)
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_orig_open_quote,`orig_open_quote()`]]`((orig_open_quote))()` +
[[m_orig_close_quote,`orig_close_quote()`]]`((orig_close_quote))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_printable_open_quote,`printable_open_quote()`]]`((printable_open_quote))()` +
[[m_printable_close_quote,`printable_close_quote()`]]`((printable_close_quote))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_UNDEFINED,`UNDEFINED()`]]`((UNDEFINED))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_append_var,`append_var(...)`]]`((append_var))(Name, String)` +
[[m_prepend_var,`prepend_var(...)`]]`((prepend_var))(Name, String)` +
[[m_append_macro,`append_macro(...)`]]`((append_macro))(Name, String)` +
[[m_prepend_macro,`prepend_macro(...)`]]`((prepend_macro))(Name, String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_substr,`substr(...)`]]`((substr))(String, From, Length)` +
[[m_substr_eval,`substr_eval(...)`]]`((substr_eval))(String, From, Length)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_translit,`translit(...)`]]`((translit))(String, InChars, OutChars)` +
[[m_translit_eval,`translit_eval(...)`]]`((translit_eval))(String, InChars, OutChars)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_uppercase,`uppercase(...)`]]`((uppercase))(String)` +
[[m_lowercase,`lowercase(...)`]]`((lowercase))(String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_replicate,`replicate(...)`]]`((replicate))(Cnt, String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_strip_trailing_whitespace_from,`strip_trailing_whitespace_from(...)`]]`((strip_trailing_whitespace_from))(Var)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_format_eval,`format_eval(...)`]]`((format_eval))(string, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_index_of,`index_of(...)`]]`((index_of))(String, Substring)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_num_lines,`num_lines(...)`]]`((num_lines))(String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_for_each_line,`for_each_line(...)`]]`((for_each_line))(Text, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_dequote,`dequote(...)`]]`((dequote))(String)` +
[[m_requote,`requote(...)`]]`((requote))(String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_output_with_restored_quotes,`output_with_restored_quotes(...)`]]`((output_with_restored_quotes))(String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_no_quotes,`no_quotes(...)`]]`((no_quotes))(String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_regex,`regex(...)`]]`((regex))(String, Regex, Replacement)` +
[[m_regex_eval,`regex_eval(...)`]]`((regex_eval))(String, Regex, Replacement)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
|Searches for the first occurence of `Regexp` in `String`, resulting in either the position of the match
or its replacement.
...
[[m_var_regex,`var_regex(...)`]]`((var_regex))(String, Regex, VarList)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_if_regex,`if_regex(...)`]]`((if_regex))(String, Regex, VarList, Body, ...)` +
[[m_else_if_regex,`else_if_regex(...)`]]`((else_if_regex))(String, Regex, VarList, Body, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_for_each_regex,`for_each_regex(...)`]]`((for_each_regex))(String, Regex, VarList, Body)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
|Evaluate body for every pattern matching regex in the first line of `String`.
<<v_status>> is unassigned.
...
|See also:
|<<m_regex>>, <<m_for_each_line>>, <<m_regex_eval>>, <<m_if_regex>>, <<m_else_if_regex>>
|===
...
[[m_get_ago,`get_ago(...)`]]`((get_ago))(Name, Ago)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_depth_of,`depth_of(...)`]]`((depth_of))(Name)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_shift,`shift(...)`]]`((shift))(...)` +
[[m_comma_shift,`comma_shift(...)`]]`((comma_shift))(...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_comma_args,`comma_args(...)`]]`((comma_args))(...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_echo_args,`echo_args(...)`]]`((echo_args))(...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_calc,`calc(...)`]]`((calc))(Expr, Radix, Width)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_equate,`equate(...)`]]`((equate))(Name, Expr)` +
[[m_operate_on,`operate_on(...)`]]`((operate_on))(Name, Expr)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_increment,`increment(...)`]]`((increment))(Name, Amount)` +
[[m_decrement,`decrement(...)`]]`((decrement))(Name, Amount)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_is_null,`is_null(...)`]]`((is_null))(Name)` +
[[m_isnt_null,`isnt_null(...)`]]`((isnt_null))(Name)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_eq,`eq(...)`]]`((eq))(String1, String2, ...)` +
[[m_neq,`neq(...)`]]`((neq))(String1, String2, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Output:
...
[[m_fn_args,`fn_args()`]]`((fn_args))()` +
[[m_comma_fn_args,`comma_fn_args()`]]`((comma_fn_args))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_fn_arg_cnt,`fn_arg_cnt()`]]`((fn_arg_cnt))()`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_out,`out(...)`]]`((out))(String)` +
[[m_out_eval,`out_eval(...)`]]`((out_eval))(String)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_return_status,`return_status(...)`]]`((return_status))(Value)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_on_return,`on_return(...)`]]`((on_return))(MacroName, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
|See also:
|<<m_return_status>>, <<Aftermath>>
|===


=== Checking and Debugging

[[m_debug_level,`debug_level(...)`]]`((debug_level))(level)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_errprint,`errprint(...)`]]`((errprint))(text)` +
[[m_errprint_nl,`errprint_nl(...)`]]`((errprint_nl))(text)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_warning,`warning(...)`]]`((warning))(message)` +
[[m_error,`error(...)`]]`((error))(message)` +
[[m_fatal_error,`fatal_error(...)`]]`((fatal_error))(message)` +
[[m_DEBUG,`DEBUG(...)`]]`((DEBUG))(message)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
|Report an error/warning/debug message and stack trace (except for `DEBUG`).
...
[[m_warning_if,`warning_if(...)`]]`((warning_if))(condition, message)` +
[[m_error_if,`error_if(...)`]]`((error_if))(condition, message)` +
[[m_fatal_error_if,`fatal_error_if(...)`]]`((fatal_error_if))(condition, message)` +
[[m_DEBUG_if,`DEBUG_if(...)`]]`((DEBUG_if))(condition, message)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_assert,`assert(...)`]]`((assert))(condition)` +
[[m_fatal_assert,`fatal_assert(...)`]]`((fatal_assert))(condition)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_verify_min_args,`verify_min_args(...)`]]`((verify_min_args))(Name, Min, Actual)` +
[[m_verify_num_args,`verify_num_args(...)`]]`((verify_num_args))(Name, Min, Actual)` +
[[m_verify_min_max_args,`verify_min_max_args(...)`]]`((verify_min_max_args))(Name, Min, Max, Actual)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[v_recursion_limit,`$recursion_limit`]]`$((recursion_limit))` (Universal variable)
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
...
[[m_abbreviate_args,`abbreviate_args(...)`]]`((abbreviate_args))(max_args, max_arg_length, ...)`
[frame=none,grid=none,cols=">1, 5a"]
|===
|Description:
